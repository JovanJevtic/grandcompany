...
initPage(() => {
  ...
  $('contact-form').addEventListener('submit', (e) => {
    ...
    $('contact-form').outerHTML = `
      <div class="self-start border border-ink/15 bg-surface p-8 lg:col-span-7 lg:col-start-6" role="status">
        <p class="text-[15px] text-sage">Upit je zabilježen</p>
        <p class="mt-2 font-serif text-[33px] leading-tight">Hvala, ${esc(name)}.</p>
        <p class="mt-3 max-w-[56ch] text-[16px] leading-relaxed text-muted">Komercijalista vas kontaktira na ${esc(phone)}. U demo verziji poruka se ne šalje nikome.</p>
